...
class EmployersControllerTest < ActionController::TestCase
  ...
  test "should create employer" do
    assert_difference('Employer.count') do
      post :create, employer: { admin_id: @employer.admin_id, company_name: @employer.company_name, contact_name: @employer.contact_name, email: @employer.email, password: @employer.password }
    end
  ...
  test "should update employer" do
    patch :update, id: @employer, employer: { admin_id: @employer.admin_id, company_name: @employer.company_name, contact_name: @employer.contact_name, email: @employer.email, password: @employer.password }
    assert_redirected_to employer_path(assigns(:employer))
  end
